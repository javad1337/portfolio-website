...
const skills: Skill[] = [
	{ name: 'Dart', level: 95 },
	{ name: 'Flutter SDK', level: 90 },
	{ name: 'Testing & QA', level: 85 },
	{ name: 'CI/CD', level: 80 },
	{ name: 'Firebase', level: 95 },
	{ name: 'State Management', level: 90 },
	{ name: 'App Store & Play Store Deployment', level: 100 },
	{ name: 'Architecture & Design Patterns', level: 85 },
	{ name: 'Backend & Data Integration', level: 90 },
	{ name: 'Platform & Native Integration', level: 80 },
];
								...
								<div className="flex flex-wrap sm:flex-nowrap justify-between mb-2 gap-2">
									<div className="flex flex-wrap sm:flex-nowrap items-center gap-2">
										...
										<div className="flex flex-wrap sm:flex-nowrap gap-1">
											{skill.name === 'Dart' && (
												<span className="px-2 py-0.5 text-xs rounded-full bg-blue-500/10 text-blue-400 border border-blue-500/20">Language & Null-Safety</span>
											)}
											{skill.name === 'Flutter SDK' && (
												<span className="px-2 py-0.5 text-xs rounded-full bg-orange-500/10 text-orange-400 border border-orange-500/20">Widgets, Rendering & Layout</span>
											)}
											{skill.name === 'Testing & QA' && (
												<span className="px-2 py-0.5 text-xs rounded-full bg-green-500/10 text-green-400 border border-green-500/20">Unit, Widget, Integration</span>
											)}
											{skill.name === 'CI/CD' && (
												<span className="px-2 py-0.5 text-xs rounded-full bg-purple-500/10 text-purple-400 border border-purple-500/20">Fastlane, Codemagic, GitHub</span>
											)}
										</div>
									</div>
