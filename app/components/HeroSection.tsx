						...
						<div className="bg-gradient-to-b from-gray-900 to-gray-800 rounded-2xl overflow-hidden relative">
							...
							<div className="relative p-8">
								...
								<div className="text-center mt-6">
									...
									<p className="text-gray-400 mb-6 group-hover:text-gray-300 transition-colors">Mind-to-Body Therapy</p>
									...
									<div className="flex flex-wrap justify-center gap-2">
										{['Cross-Platform', 'Real-time Sync', 'Health AI'].map((feature, index) => (
											<span
												key={index}
